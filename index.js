    ...
    var policyHookDef = {
        ...
        loadMiddleware: function(cb) {
            ...
            sails.modules.loadPolicies(function modulesLoaded (err, modules) {
                ...
                //console.log('sails.middleware.policies', sails.middleware.policies);
                return cb();
            }.bind(this));
        },
        ...
        normalizePolicy: function (policy) {
            ...
            /**
             * This line was added to support auto building of policies
             */
            if (_.isObject(policy) && policy.build) {
                policy = policy.build();
            }
